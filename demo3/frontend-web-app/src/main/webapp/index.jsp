...
<html>
    ...
    <body style="display: block">
        ...
        <p>
            <b>Refresh Token:</b>
            <div class="message" id="refreshToken"><% out.print(controller.storeRefreshToken(request)); %></div>
        </p>
        ...
        <div class="wrapper">
            ...
            <c:if test="${isLoggedIn}">
                <div id="is-authenticated" style="display: block" class="menu">
                    <button name="logoutBtn" onclick="location.href = 'logout.jsp'" type="button">Logout</button>
                </div>
            </c:if>
            ...
            <div class="content">
                ...
                <div class="message" id="message"><% out.print(controller.getMessage(request, getServletContext())); %></div>
            </div>
        </div>
    </body>
</html>
